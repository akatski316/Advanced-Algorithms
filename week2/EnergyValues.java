...
class EnergyValues {
    ...
    static Position SelectPivotElement(double a[][], boolean used_raws[], boolean used_columns[],int x,int y) 
    {
       ...
       /* Position pivot_element = new Position(0, 0);
        ...
        while(used_raws[pivot_element.raw] || pivot_element.raw != 0)
            ++pivot_element.raw;

        while(used_columns[pivot_element.column] || pivot_element)
    ...
    */   
    ...
    static double[] SolveEquation(Equation equation) 
    {
        ...
        {
            pivot_element = SelectPivotElement(a, used_raws, used_columns, pivot_element.raw+1, pivot_element.column+1);
